...
| `FRONTEND_IMAGE` | Frontend image name | `guidellm-benchmarker` |
| `BFF_IMAGE` | BFF image name | `guidellm-benchmarker-bff` |
| `CHART_NAME` | Helm chart name | `guidellm-benchmarker-chart` |
...
- **Registry**: `quay.io`
- **Frontend image**: `quay.io/OWNER/guidellm-benchmarker`
- **BFF image**: `quay.io/OWNER/guidellm-benchmarker-bff`
...
podman build -t quay.io/OWNER/guidellm-benchmarker:0.5.0 -f Containerfile .
podman push quay.io/OWNER/guidellm-benchmarker:0.5.0

podman build -t quay.io/OWNER/guidellm-benchmarker-bff:0.5.0 -f bff/Containerfile bff/
podman push quay.io/OWNER/guidellm-benchmarker-bff:0.5.0
```
...
- **Chart name**: `guidellm-benchmarker-chart`
- **OCI registry**: `oci://quay.io/OWNER/guidellm-benchmarker-chart`
...
This produces a `guidellm-benchmarker-chart-<version>.tgz` file in the current directory, using the version from `chart/Chart.yaml`.
...
helm push guidellm-benchmarker-chart-<version>.tgz oci://quay.io/rh-ai-community-plugins
```
