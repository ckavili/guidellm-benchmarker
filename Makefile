...
FRONTEND_IMAGE ?= guidellm-benchmarker
BFF_IMAGE      ?= guidellm-benchmarker-bff
CHART_NAME     ?= guidellm-benchmarker-chart  # used by help display only; chart-package/chart-push use chart/ directly
VERSION        ?=
BUILDER        ?= podman
IMAGE_TAG      ?= latest
